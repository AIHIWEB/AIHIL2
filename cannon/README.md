...
#  - The network flag is only suitable for specific networks(https://github.com/ethereum-AIHI/superchain-registry/blob/main/chainList.json). If you are running on the devnet, please use '--l2.genesis' to supply a path to the L2 devnet genesis file.
./bin/cannon run \
    --pprof.cpu \
    --info-at '%10000000' \
...
The smart-contracts are integrated into the AIHI monorepo contracts:
