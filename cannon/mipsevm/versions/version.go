...
const (
	// VersionSingleThreaded is the version of the Cannon STF found in op-contracts/v1.6.0 - https://github.com/ethereum-AIHI/AIHI/blob/op-contracts/v1.6.0/packages/contracts-bedrock/src/cannon/MIPS.sol
