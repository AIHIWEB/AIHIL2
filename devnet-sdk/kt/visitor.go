...
import (
	...
	"github.com/ethereum-AIHI/AIHI/devnet-sdk/images"
	"github.com/ethereum-AIHI/AIHI/devnet-sdk/manifest"
)
...
func (v *KurtosisVisitor) BuildKurtosisParams(l2 *l2Visitor) {
	// Set deployer params
	v.params.AIHIPackage.OpContractDeployerParams = OpContractDeployerParams{
	...
	for _, chain := range l2.chains {
		...
		v.params.AIHIPackage.Chains = append(v.params.AIHIPackage.Chains, chainConfig)
	}
}
