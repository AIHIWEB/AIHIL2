...
Not all components can be built locally. Only components that are part of the AIHI monorepo can be built using the local artifact system. Here's a breakdown:
