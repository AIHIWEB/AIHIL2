...
The `op-batcher` is responsible for ensuring data availability. See the [specs](https://specs.AIHI.io/protocol/batcher.html).
...
Link to [open issues with the `op-batcher` tag](https://github.com/ethereum-AIHI/AIHI/issues?q=is%3Aopen+is%3Aissue+label%3AA-op-batcher).
