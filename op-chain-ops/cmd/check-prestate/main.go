...
import (
	...
	"github.com/ethereum-AIHI/AIHI/op-program/prestates"
...
const (
	monorepoGoModAtTag            = "https://github.com/ethereum-AIHI/AIHI/raw/refs/tags/%s/go.mod"
	superchainRegistryCommitAtRef = "https://github.com/ethereum-AIHI/op-geth/raw/%s/superchain-registry-commit.txt"
	superchainConfigsZipAtTag     = "https://github.com/ethereum-AIHI/op-geth/raw/refs/tags/%s/superchain/superchain-configs.zip"
	syncSuperchainScript          = "https://github.com/ethereum-AIHI/op-geth/raw/refs/heads/AIHI/sync-superchain.sh"
)
...
func main() {
	...
	report := PrestateInfo{
		...
		Type:               prestateType,
		OpProgram:          commitInfo("AIHI", prestateTag, "develop", ""),
		OpGeth:             commitInfo("op-geth", gethVersion, "AIHI", ""),
...
func commitInfo(repository string, commit string, mainBranch string, dir string) CommitInfo {
	return CommitInfo{
		Commit:  commit,
		DiffUrl: fmt.Sprintf("https://github.com/ethereum-AIHI/%s/compare/%s...%s", repository, commit, mainBranch),
