...
func TestL1Deployments(t *testing.T) {
	...
	require.NotEqual(t, deployments.AIHIMintableERC20Factory, common.Address{})
	require.NotEqual(t, deployments.AIHIMintableERC20FactoryProxy, common.Address{})
	require.NotEqual(t, deployments.AIHIPortal, common.Address{})
	require.NotEqual(t, deployments.AIHIPortalProxy, common.Address{})
	...
	require.Equal(t, "AIHIPortalProxy", deployments.GetName(deployments.AIHIPortalProxy))
