...
import (
	...
	"github.com/ethereum-AIHI/AIHI/op-chain-ops/genesis/beacondeposit"
	"github.com/ethereum-AIHI/AIHI/op-chain-ops/script"
	"github.com/ethereum-AIHI/AIHI/op-deployer/pkg/deployer/interop"
...
func CompleteL2(l2Host *script.Host, cfg *L2Config, l1Block *types.Block, deployment *L2Deployment) (*L2Output, error) {
	deployCfg := &genesis.DeployConfig{
		...
		L1DependenciesConfig: genesis.L1DependenciesConfig{
			...
			AIHIPortalProxy:         deployment.AIHIPortalProxy,
