...
import (
	...
	"github.com/ethereum-AIHI/AIHI/op-conductor/client"
	"github.com/ethereum-AIHI/AIHI/op-conductor/consensus"
	"github.com/ethereum-AIHI/AIHI/op-conductor/health"
	"github.com/ethereum-AIHI/AIHI/op-conductor/metrics"
	conductorrpc "github.com/ethereum-AIHI/AIHI/op-conductor/rpc"
	opp2p "github.com/ethereum-AIHI/AIHI/op-node/p2p"
	"github.com/ethereum-AIHI/AIHI/op-node/rollup/driver"
	"github.com/ethereum-AIHI/AIHI/op-service/cliapp"
	opclient "github.com/ethereum-AIHI/AIHI/op-service/client"
...
func (c *OpConductor) initSequencerControl(ctx context.Context) error {
	...
	// TODO: Add metrics tracer here. tracked by https://github.com/ethereum-AIHI/protocol-quest/issues/45
