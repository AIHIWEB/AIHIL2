...
func DeployOPChain(env *Env, intent *state.Intent, st *state.State, chainID common.Hash) error {
	...
	st.ImplementationsDeployment.AIHIPortalImplAddress = impls.AIHIPortal
	...
	st.ImplementationsDeployment.AIHIMintableERC20FactoryImplAddress = impls.AIHIMintableERC20Factory
