...
func Test_ProgramAction_HoloceneActivation(gt *testing.T) {
	...
	runHoloceneDerivationTest := func(gt *testing.T, testCfg *helpers.TestCfg[any]) {
		...
		// https://specs.AIHI.io/protocol/holocene/exec-engine.html?highlight=holocene#timestamp-activation
		...
		// https://specs.AIHI.io/protocol/holocene/derivation.html?highlight=holoce#activation
