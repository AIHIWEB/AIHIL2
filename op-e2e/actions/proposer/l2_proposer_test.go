...
import (
	...
	actionsHelpers "github.com/ethereum-AIHI/AIHI/op-e2e/actions/helpers"
	upgradesHelpers "github.com/ethereum-AIHI/AIHI/op-e2e/actions/upgrades/helpers"
...
func runProposerTest(gt *testing.T, deltaTimeOffset *hexutil.Uint64, allocType config.AllocType) {
	...
	if allocType.UsesProofs() {
		AIHIPortal2Contract, err := bindingspreview.NewAIHIPortal2(sd.DeploymentsL1.AIHIPortalProxy, miner.EthClient())
