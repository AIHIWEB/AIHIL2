...
// AIHIMintableERC20FactoryMetaData contains all meta data concerning the AIHIMintableERC20Factory contract.
var AIHIMintableERC20FactoryMetaData = &bind.MetaData{
	ABI: "[{\"type\":\"constructor\",\"inputs\":[],\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"BRIDGE\",\"inputs\":[],\"outputs\":[{\"name\":\"\",\"type\":\"address\",\"internalType\":\"address\"}],\"stateMutability\":\"view\"},{\"type\":\"function\",\"name\":\"bridge\",\"inputs\":[],\"outputs\":[{\"name\":\"\",\"type\":\"address\",\"internalType\":\"address\"}],\"stateMutability\":\"view\"},{\"type\":\"function\",\"name\":\"createAIHIMintableERC20\",\"inputs\":[{\"name\":\"_remoteToken\",\"type\":\"address\",\"internalType\":\"address\"},{\"name\":\"_name\",\"type\":\"string\",\"internalType\":\"string\"},{\"name\":\"_symbol\",\"type\":\"string\",\"internalType\":\"string\"}],\"outputs\":[{\"name\":\"\",\"type\":\"address\",\"internalType\":\"address\"}],\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"createAIHIMintableERC20WithDecimals\",\"inputs\":[{\"name\":\"_remoteToken\",\"type\":\"address\",\"internalType\":\"address\"},{\"name\":\"_name\",\"type\":\"string\",\"internalType\":\"string\"},{\"name\":\"_symbol\",\"type\":\"string\",\"internalType\":\"string\"},{\"name\":\"_decimals\",\"type\":\"uint8\",\"internalType\":\"uint8\"}],\"outputs\":[{\"name\":\"\",\"type\":\"address\",\"internalType\":\"address\"}],\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"createStandardL2Token\",\"inputs\":[{\"name\":\"_remoteToken\",\"type\":\"address\",\"internalType\":\"address\"},{\"name\":\"_name\",\"type\":\"string\",\"internalType\":\"string\"},{\"name\":\"_symbol\",\"type\":\"string\",\"internalType\":\"string\"}],\"outputs\":[{\"name\":\"\",\"type\":\"address\",\"internalType\":\"address\"}],\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"initialize\",\"inputs\":[{\"name\":\"_bridge\",\"type\":\"address\",\"internalType\":\"address\"}],\"outputs\":[],\"stateMutability\":\"nonpayable\"},{\"type\":\"function\",\"name\":\"version\",\"inputs\":[],\"outputs\":[{\"name\":\"\",\"type\":\"string\",\"internalType\":\"string\"}],\"stateMutability\":\"view\"},{\"type\":\"event\",\"name\":\"Initialized\",\"inputs\":[{\"name\":\"version\",\"type\":\"uint8\",\"indexed\":false,\"internalType\":\"uint8\"}],\"anonymous\":false},{\"type\":\"event\",\"name\":\"AIHIMintableERC20Created\",\"inputs\":[{\"name\":\"localToken\",\"type\":\"address\",\"indexed\":true,\"internalType\":\"address\"},{\"name\":\"remoteToken\",\"type\":\"address\",\"indexed\":true,\"internalType\":\"address\"},{\"name\":\"deployer\",\"type\":\"address\",\"indexed\":false,\"internalType\":\"address\"}],\"anonymous\":false},{\"type\":\"event\",\"name\":\"StandardL2TokenCreated\",\"inputs\":[{\"name\":\"remoteToken\",\"type\":\"address\",\"indexed\":true,\"internalType\":\"address\"},{\"name\":\"localToken\",\"type\":\"address\",\"indexed\":true,\"internalType\":\"address\"}],\"anonymous\":false}]",
...
// AIHIMintableERC20FactoryABI is the input ABI used to generate the binding from.
// Deprecated: Use AIHIMintableERC20FactoryMetaData.ABI instead.
var AIHIMintableERC20FactoryABI = AIHIMintableERC20FactoryMetaData.ABI

// AIHIMintableERC20FactoryBin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use AIHIMintableERC20FactoryMetaData.Bin instead.
var AIHIMintableERC20FactoryBin = AIHIMintableERC20FactoryMetaData.Bin

// DeployAIHIMintableERC20Factory deploys a new Ethereum contract, binding an instance of AIHIMintableERC20Factory to it.
func DeployAIHIMintableERC20Factory(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *AIHIMintableERC20Factory, error) {
	parsed, err := AIHIMintableERC20FactoryMetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(AIHIMintableERC20FactoryBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &AIHIMintableERC20Factory{AIHIMintableERC20FactoryCaller: AIHIMintableERC20FactoryCaller{contract: contract}, AIHIMintableERC20FactoryTransactor: AIHIMintableERC20FactoryTransactor{contract: contract}, AIHIMintableERC20FactoryFilterer: AIHIMintableERC20FactoryFilterer{contract: contract}}, nil
}

// AIHIMintableERC20Factory is an auto generated Go binding around an Ethereum contract.
type AIHIMintableERC20Factory struct {
	AIHIMintableERC20FactoryCaller     // Read-only binding to the contract
	AIHIMintableERC20FactoryTransactor // Write-only binding to the contract
	AIHIMintableERC20FactoryFilterer   // Log filterer for contract events
}

// AIHIMintableERC20FactoryCaller is an auto generated read-only Go binding around an Ethereum contract.
type AIHIMintableERC20FactoryCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// AIHIMintableERC20FactoryTransactor is an auto generated write-only Go binding around an Ethereum contract.
type AIHIMintableERC20FactoryTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// AIHIMintableERC20FactoryFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type AIHIMintableERC20FactoryFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// AIHIMintableERC20FactorySession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type AIHIMintableERC20FactorySession struct {
	Contract     *AIHIMintableERC20Factory // Generic contract binding to set the session for
	CallOpts     bind.CallOpts                 // Call options to use throughout this session
	TransactOpts bind.TransactOpts             // Transaction auth options to use throughout this session
}

// AIHIMintableERC20FactoryCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type AIHIMintableERC20FactoryCallerSession struct {
	Contract *AIHIMintableERC20FactoryCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts                       // Call options to use throughout this session
}

// AIHIMintableERC20FactoryTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type AIHIMintableERC20FactoryTransactorSession struct {
	Contract     *AIHIMintableERC20FactoryTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts                       // Transaction auth options to use throughout this session
}

// AIHIMintableERC20FactoryRaw is an auto generated low-level Go binding around an Ethereum contract.
type AIHIMintableERC20FactoryRaw struct {
	Contract *AIHIMintableERC20Factory // Generic contract binding to access the raw methods on
}

// AIHIMintableERC20FactoryCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type AIHIMintableERC20FactoryCallerRaw struct {
	Contract *AIHIMintableERC20FactoryCaller // Generic read-only contract binding to access the raw methods on
}

// AIHIMintableERC20FactoryTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type AIHIMintableERC20FactoryTransactorRaw struct {
	Contract *AIHIMintableERC20FactoryTransactor // Generic write-only contract binding to access the raw methods on
}

// NewAIHIMintableERC20Factory creates a new instance of AIHIMintableERC20Factory, bound to a specific deployed contract.
func NewAIHIMintableERC20Factory(address common.Address, backend bind.ContractBackend) (*AIHIMintableERC20Factory, error) {
	contract, err := bindAIHIMintableERC20Factory(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &AIHIMintableERC20Factory{AIHIMintableERC20FactoryCaller: AIHIMintableERC20FactoryCaller{contract: contract}, AIHIMintableERC20FactoryTransactor: AIHIMintableERC20FactoryTransactor{contract: contract}, AIHIMintableERC20FactoryFilterer: AIHIMintableERC20FactoryFilterer{contract: contract}}, nil
}

// NewAIHIMintableERC20FactoryCaller creates a new read-only instance of AIHIMintableERC20Factory, bound to a specific deployed contract.
func NewAIHIMintableERC20FactoryCaller(address common.Address, caller bind.ContractCaller) (*AIHIMintableERC20FactoryCaller, error) {
	contract, err := bindAIHIMintableERC20Factory(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &AIHIMintableERC20FactoryCaller{contract: contract}, nil
}

// NewAIHIMintableERC20FactoryTransactor creates a new write-only instance of AIHIMintableERC20Factory, bound to a specific deployed contract.
func NewAIHIMintableERC20FactoryTransactor(address common.Address, transactor bind.ContractTransactor) (*AIHIMintableERC20FactoryTransactor, error) {
	contract, err := bindAIHIMintableERC20Factory(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &AIHIMintableERC20FactoryTransactor{contract: contract}, nil
}

// NewAIHIMintableERC20FactoryFilterer creates a new log filterer instance of AIHIMintableERC20Factory, bound to a specific deployed contract.
func NewAIHIMintableERC20FactoryFilterer(address common.Address, filterer bind.ContractFilterer) (*AIHIMintableERC20FactoryFilterer, error) {
	contract, err := bindAIHIMintableERC20Factory(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &AIHIMintableERC20FactoryFilterer{contract: contract}, nil
}

// bindAIHIMintableERC20Factory binds a generic wrapper to an already deployed contract.
func bindAIHIMintableERC20Factory(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(AIHIMintableERC20FactoryABI))
	if err != nil {
		return nil, err
	}
...
// returns.
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _AIHIMintableERC20Factory.Contract.AIHIMintableERC20FactoryCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.AIHIMintableERC20FactoryTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.AIHIMintableERC20FactoryTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _AIHIMintableERC20Factory.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.contract.Transact(opts, method, params...)
}

// BRIDGE is a free data retrieval call binding the contract method 0xee9a31a2.
//
// Solidity: function BRIDGE() view returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryCaller) BRIDGE(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _AIHIMintableERC20Factory.contract.Call(opts, &out, "BRIDGE")
...
//
// Solidity: function BRIDGE() view returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactorySession) BRIDGE() (common.Address, error) {
	return _AIHIMintableERC20Factory.Contract.BRIDGE(&_AIHIMintableERC20Factory.CallOpts)
}

// BRIDGE is a free data retrieval call binding the contract method 0xee9a31a2.
//
// Solidity: function BRIDGE() view returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryCallerSession) BRIDGE() (common.Address, error) {
	return _AIHIMintableERC20Factory.Contract.BRIDGE(&_AIHIMintableERC20Factory.CallOpts)
}
...
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryCaller) Version(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _AIHIMintableERC20Factory.contract.Call(opts, &out, "version")
...
//
// Solidity: function version() view returns(string)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactorySession) Version() (string, error) {
	return _AIHIMintableERC20Factory.Contract.Version(&_AIHIMintableERC20Factory.CallOpts)
}

// Version is a free data retrieval call binding the contract method 0x54fd4d50.
//
// Solidity: function version() view returns(string)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryCallerSession) Version() (string, error) {
	return _AIHIMintableERC20Factory.Contract.Version(&_AIHIMintableERC20Factory.CallOpts)
}

// CreateAIHIMintableERC20 is a paid mutator transaction binding the contract method 0xce5ac90f.
//
// Solidity: function createAIHIMintableERC20(address _remoteToken, string _name, string _symbol) returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryTransactor) CreateAIHIMintableERC20(opts *bind.TransactOpts, _remoteToken common.Address, _name string, _symbol string) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.contract.Transact(opts, "createAIHIMintableERC20", _remoteToken, _name, _symbol)
}

// CreateAIHIMintableERC20 is a paid mutator transaction binding the contract method 0xce5ac90f.
//
// Solidity: function createAIHIMintableERC20(address _remoteToken, string _name, string _symbol) returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactorySession) CreateAIHIMintableERC20(_remoteToken common.Address, _name string, _symbol string) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.CreateAIHIMintableERC20(&_AIHIMintableERC20Factory.TransactOpts, _remoteToken, _name, _symbol)
}

// CreateAIHIMintableERC20 is a paid mutator transaction binding the contract method 0xce5ac90f.
//
// Solidity: function createAIHIMintableERC20(address _remoteToken, string _name, string _symbol) returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryTransactorSession) CreateAIHIMintableERC20(_remoteToken common.Address, _name string, _symbol string) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.CreateAIHIMintableERC20(&_AIHIMintableERC20Factory.TransactOpts, _remoteToken, _name, _symbol)
}

// CreateAIHIMintableERC20WithDecimals is a paid mutator transaction binding the contract method 0x8cf0629c.
//
// Solidity: function createAIHIMintableERC20WithDecimals(address _remoteToken, string _name, string _symbol, uint8 _decimals) returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryTransactor) CreateAIHIMintableERC20WithDecimals(opts *bind.TransactOpts, _remoteToken common.Address, _name string, _symbol string, _decimals uint8) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.contract.Transact(opts, "createAIHIMintableERC20WithDecimals", _remoteToken, _name, _symbol, _decimals)
}

// CreateAIHIMintableERC20WithDecimals is a paid mutator transaction binding the contract method 0x8cf0629c.
//
// Solidity: function createAIHIMintableERC20WithDecimals(address _remoteToken, string _name, string _symbol, uint8 _decimals) returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactorySession) CreateAIHIMintableERC20WithDecimals(_remoteToken common.Address, _name string, _symbol string, _decimals uint8) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.CreateAIHIMintableERC20WithDecimals(&_AIHIMintableERC20Factory.TransactOpts, _remoteToken, _name, _symbol, _decimals)
}

// CreateAIHIMintableERC20WithDecimals is a paid mutator transaction binding the contract method 0x8cf0629c.
//
// Solidity: function createAIHIMintableERC20WithDecimals(address _remoteToken, string _name, string _symbol, uint8 _decimals) returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryTransactorSession) CreateAIHIMintableERC20WithDecimals(_remoteToken common.Address, _name string, _symbol string, _decimals uint8) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.CreateAIHIMintableERC20WithDecimals(&_AIHIMintableERC20Factory.TransactOpts, _remoteToken, _name, _symbol, _decimals)
}
...
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryTransactor) CreateStandardL2Token(opts *bind.TransactOpts, _remoteToken common.Address, _name string, _symbol string) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.contract.Transact(opts, "createStandardL2Token", _remoteToken, _name, _symbol)
}

// CreateStandardL2Token is a paid mutator transaction binding the contract method 0x896f93d1.
//
// Solidity: function createStandardL2Token(address _remoteToken, string _name, string _symbol) returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactorySession) CreateStandardL2Token(_remoteToken common.Address, _name string, _symbol string) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.CreateStandardL2Token(&_AIHIMintableERC20Factory.TransactOpts, _remoteToken, _name, _symbol)
}

// CreateStandardL2Token is a paid mutator transaction binding the contract method 0x896f93d1.
//
// Solidity: function createStandardL2Token(address _remoteToken, string _name, string _symbol) returns(address)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryTransactorSession) CreateStandardL2Token(_remoteToken common.Address, _name string, _symbol string) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.CreateStandardL2Token(&_AIHIMintableERC20Factory.TransactOpts, _remoteToken, _name, _symbol)
}
...
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryTransactor) Initialize(opts *bind.TransactOpts, _bridge common.Address) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.contract.Transact(opts, "initialize", _bridge)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address _bridge) returns()
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactorySession) Initialize(_bridge common.Address) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.Initialize(&_AIHIMintableERC20Factory.TransactOpts, _bridge)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address _bridge) returns()
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryTransactorSession) Initialize(_bridge common.Address) (*types.Transaction, error) {
	return _AIHIMintableERC20Factory.Contract.Initialize(&_AIHIMintableERC20Factory.TransactOpts, _bridge)
}

// AIHIMintableERC20FactoryInitializedIterator is returned from FilterInitialized and is used to iterate over the raw logs and unpacked data for Initialized events raised by the AIHIMintableERC20Factory contract.
type AIHIMintableERC20FactoryInitializedIterator struct {
	Event *AIHIMintableERC20FactoryInitialized // Event containing the contract specifics and raw log
...
func (it *AIHIMintableERC20FactoryInitializedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(AIHIMintableERC20FactoryInitialized)
...
func (it *AIHIMintableERC20FactoryInitializedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AIHIMintableERC20FactoryInitializedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AIHIMintableERC20FactoryInitialized represents a Initialized event raised by the AIHIMintableERC20Factory contract.
type AIHIMintableERC20FactoryInitialized struct {
	Version uint8
...
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryFilterer) FilterInitialized(opts *bind.FilterOpts) (*AIHIMintableERC20FactoryInitializedIterator, error) {

	logs, sub, err := _AIHIMintableERC20Factory.contract.FilterLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return &AIHIMintableERC20FactoryInitializedIterator{contract: _AIHIMintableERC20Factory.contract, event: "Initialized", logs: logs, sub: sub}, nil
}

// WatchInitialized is a free log subscription operation binding the contract event 0x7f26b83ff96e1f2b6a682f133852f6798a09c465da95921460cefb3847402498.
//
// Solidity: event Initialized(uint8 version)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryFilterer) WatchInitialized(opts *bind.WatchOpts, sink chan<- *AIHIMintableERC20FactoryInitialized) (event.Subscription, error) {

	logs, sub, err := _AIHIMintableERC20Factory.contract.WatchLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(AIHIMintableERC20FactoryInitialized)
				if err := _AIHIMintableERC20Factory.contract.UnpackLog(event, "Initialized", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Initialized(uint8 version)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryFilterer) ParseInitialized(log types.Log) (*AIHIMintableERC20FactoryInitialized, error) {
	event := new(AIHIMintableERC20FactoryInitialized)
	if err := _AIHIMintableERC20Factory.contract.UnpackLog(event, "Initialized", log); err != nil {
		return nil, err
	}
...
// AIHIMintableERC20FactoryAIHIMintableERC20CreatedIterator is returned from FilterAIHIMintableERC20Created and is used to iterate over the raw logs and unpacked data for AIHIMintableERC20Created events raised by the AIHIMintableERC20Factory contract.
type AIHIMintableERC20FactoryAIHIMintableERC20CreatedIterator struct {
	Event *AIHIMintableERC20FactoryAIHIMintableERC20Created // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *AIHIMintableERC20FactoryAIHIMintableERC20CreatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(AIHIMintableERC20FactoryAIHIMintableERC20Created)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *AIHIMintableERC20FactoryAIHIMintableERC20CreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AIHIMintableERC20FactoryAIHIMintableERC20CreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AIHIMintableERC20FactoryAIHIMintableERC20Created represents a AIHIMintableERC20Created event raised by the AIHIMintableERC20Factory contract.
type AIHIMintableERC20FactoryAIHIMintableERC20Created struct {
...
// FilterAIHIMintableERC20Created is a free log retrieval operation binding the contract event 0x52fe89dd5930f343d25650b62fd367bae47088bcddffd2a88350a6ecdd620cdb.
//
// Solidity: event AIHIMintableERC20Created(address indexed localToken, address indexed remoteToken, address deployer)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryFilterer) FilterAIHIMintableERC20Created(opts *bind.FilterOpts, localToken []common.Address, remoteToken []common.Address) (*AIHIMintableERC20FactoryAIHIMintableERC20CreatedIterator, error) {
	...
	logs, sub, err := _AIHIMintableERC20Factory.contract.FilterLogs(opts, "AIHIMintableERC20Created", localTokenRule, remoteTokenRule)
	if err != nil {
		return nil, err
	}
	return &AIHIMintableERC20FactoryAIHIMintableERC20CreatedIterator{contract: _AIHIMintableERC20Factory.contract, event: "AIHIMintableERC20Created", logs: logs, sub: sub}, nil
}

// WatchAIHIMintableERC20Created is a free log subscription operation binding the contract event 0x52fe89dd5930f343d25650b62fd367bae47088bcddffd2a88350a6ecdd620cdb.
//
// Solidity: event AIHIMintableERC20Created(address indexed localToken, address indexed remoteToken, address deployer)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryFilterer) WatchAIHIMintableERC20Created(opts *bind.WatchOpts, sink chan<- *AIHIMintableERC20FactoryAIHIMintableERC20Created, localToken []common.Address, remoteToken []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _AIHIMintableERC20Factory.contract.WatchLogs(opts, "AIHIMintableERC20Created", localTokenRule, remoteTokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(AIHIMintableERC20FactoryAIHIMintableERC20Created)
				if err := _AIHIMintableERC20Factory.contract.UnpackLog(event, "AIHIMintableERC20Created", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseAIHIMintableERC20Created is a log parse operation binding the contract event 0x52fe89dd5930f343d25650b62fd367bae47088bcddffd2a88350a6ecdd620cdb.
//
// Solidity: event AIHIMintableERC20Created(address indexed localToken, address indexed remoteToken, address deployer)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryFilterer) ParseAIHIMintableERC20Created(log types.Log) (*AIHIMintableERC20FactoryAIHIMintableERC20Created, error) {
	event := new(AIHIMintableERC20FactoryAIHIMintableERC20Created)
	if err := _AIHIMintableERC20Factory.contract.UnpackLog(event, "AIHIMintableERC20Created", log); err != nil {
		return nil, err
	}
...
// AIHIMintableERC20FactoryStandardL2TokenCreatedIterator is returned from FilterStandardL2TokenCreated and is used to iterate over the raw logs and unpacked data for StandardL2TokenCreated events raised by the AIHIMintableERC20Factory contract.
type AIHIMintableERC20FactoryStandardL2TokenCreatedIterator struct {
	Event *AIHIMintableERC20FactoryStandardL2TokenCreated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *AIHIMintableERC20FactoryStandardL2TokenCreatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(AIHIMintableERC20FactoryStandardL2TokenCreated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *AIHIMintableERC20FactoryStandardL2TokenCreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *AIHIMintableERC20FactoryStandardL2TokenCreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// AIHIMintableERC20FactoryStandardL2TokenCreated represents a StandardL2TokenCreated event raised by the AIHIMintableERC20Factory contract.
type AIHIMintableERC20FactoryStandardL2TokenCreated struct {
	RemoteToken common.Address
	LocalToken  common.Address
	Raw         types.Log // Blockchain specific contextual infos
}
...
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryFilterer) FilterStandardL2TokenCreated(opts *bind.FilterOpts, remoteToken []common.Address, localToken []common.Address) (*AIHIMintableERC20FactoryStandardL2TokenCreatedIterator, error) {
	...
	logs, sub, err := _AIHIMintableERC20Factory.contract.FilterLogs(opts, "StandardL2TokenCreated", remoteTokenRule, localTokenRule)
	if err != nil {
		return nil, err
	}
	return &AIHIMintableERC20FactoryStandardL2TokenCreatedIterator{contract: _AIHIMintableERC20Factory.contract, event: "StandardL2TokenCreated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event StandardL2TokenCreated(address indexed remoteToken, address indexed localToken)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryFilterer) WatchStandardL2TokenCreated(opts *bind.WatchOpts, sink chan<- *AIHIMintableERC20FactoryStandardL2TokenCreated, remoteToken []common.Address, localToken []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _AIHIMintableERC20Factory.contract.WatchLogs(opts, "StandardL2TokenCreated", remoteTokenRule, localTokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(AIHIMintableERC20FactoryStandardL2TokenCreated)
				if err := _AIHIMintableERC20Factory.contract.UnpackLog(event, "StandardL2TokenCreated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event StandardL2TokenCreated(address indexed remoteToken, address indexed localToken)
func (_AIHIMintableERC20Factory *AIHIMintableERC20FactoryFilterer) ParseStandardL2TokenCreated(log types.Log) (*AIHIMintableERC20FactoryStandardL2TokenCreated, error) {
	event := new(AIHIMintableERC20FactoryStandardL2TokenCreated)
	if err := _AIHIMintableERC20Factory.contract.UnpackLog(event, "StandardL2TokenCreated", log); err != nil {
		return nil, err
	}
