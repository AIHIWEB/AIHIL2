...
import (
	...
	bss "github.com/ethereum-AIHI/AIHI/op-batcher/batcher"
	...
	"github.com/ethereum-AIHI/AIHI/op-e2e/config/secrets"
	"github.com/ethereum-AIHI/AIHI/op-e2e/e2eutils"
	"github.com/ethereum-AIHI/AIHI/op-e2e/e2eutils/batcher"
	"github.com/ethereum-AIHI/AIHI/op-e2e/e2eutils/fakebeacon"
	"github.com/ethereum-AIHI/AIHI/op-e2e/e2eutils/geth"
	"github.com/ethereum-AIHI/AIHI/op-e2e/e2eutils/opnode"
	"github.com/ethereum-AIHI/AIHI/op-e2e/e2eutils/services"
	"github.com/ethereum-AIHI/AIHI/op-e2e/e2eutils/setuputils"
	...
	"github.com/ethereum-AIHI/AIHI/op-node/p2p/store"
	"github.com/ethereum-AIHI/AIHI/op-node/rollup"
	"github.com/ethereum-AIHI/AIHI/op-node/rollup/derive"
	"github.com/ethereum-AIHI/AIHI/op-node/rollup/driver"
	"github.com/ethereum-AIHI/AIHI/op-node/rollup/sync"
	l2os "github.com/ethereum-AIHI/AIHI/op-proposer/proposer"
	...
	opsigner "github.com/ethereum-AIHI/AIHI/op-service/signer"
...
func (cfg SystemConfig) Start(t *testing.T, startOpts ...StartOption) (*System, error) {
	...
	makeRollupConfig := func() rollup.Config {
		return rollup.Config{
			...
			DepositContractAddress:  cfg.DeployConfig.AIHIPortalProxy,
