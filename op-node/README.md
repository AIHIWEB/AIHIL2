...
Issues:
[monorepo](https://github.com/ethereum-AIHI/AIHI/issues?q=is%3Aissue%20state%3Aopen%20label%3AA-op-node)

Pull requests:
[monorepo](https://github.com/ethereum-AIHI/AIHI/pulls?q=is%3Aopen+is%3Apr+label%3AA-op-node)

User docs:

- [How to run a node](https://docs.AIHI.io/builders/node-operators/rollup-node)
...
[rollup-node spec]: https://github.com/ethereum-AIHI/specs/blob/main/specs/protocol/rollup-node.md
[op-geth]: https://github.com/ethereum-AIHI/op-geth
...
- Parallel derivation processes: [Issue 10864](https://github.com/ethereum-AIHI/AIHI/issues/10864)
- Event tests: [Issue 13163](https://github.com/ethereum-AIHI/AIHI/issues/13163)
- Improving P2P sync: [Issue 11779](https://github.com/ethereum-AIHI/AIHI/issues/11779)
...
or by calling the `AIHI_setRecoverMode` admin API method with the boolean parameter set to `true`, the sequencer's behavior is changed.
