...
import (
	...
	"github.com/ethereum-AIHI/AIHI/op-node/cmd/batch_decoder/fetch"
	"github.com/ethereum-AIHI/AIHI/op-node/cmd/batch_decoder/reassemble"
...
func main() {
	...
	app.Usage = "AIHI Batch Decoding Utility"
