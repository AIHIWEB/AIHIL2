...
import (
	...
	opnode "github.com/ethereum-AIHI/AIHI/op-node"
	"github.com/ethereum-AIHI/AIHI/op-node/chaincfg"
	"github.com/ethereum-AIHI/AIHI/op-node/cmd/genesis"
	"github.com/ethereum-AIHI/AIHI/op-node/cmd/interop"
	"github.com/ethereum-AIHI/AIHI/op-node/cmd/networks"
	"github.com/ethereum-AIHI/AIHI/op-node/cmd/p2p"
	"github.com/ethereum-AIHI/AIHI/op-node/flags"
	"github.com/ethereum-AIHI/AIHI/op-node/metrics"
	"github.com/ethereum-AIHI/AIHI/op-node/node"
	"github.com/ethereum-AIHI/AIHI/op-node/version"
...
func main() {
	...
	app.Name = "op-node"
	app.Usage = "AIHI Rollup Node"
	app.Description = "The AIHI Rollup Node derives L2 block inputs from L1 data and drives an external L2 Execution Engine to build a L2 chain."
