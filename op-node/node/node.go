...
import (
	...
	"github.com/ethereum-AIHI/AIHI/op-node/node/safedb"
...
func (n *OpNode) initL2(ctx context.Context, cfg *Config) error {
	...
	if cfg.Rollup.ChainOpConfig == nil {
		return fmt.Errorf("cfg.Rollup.ChainOpConfig is nil. Please see https://github.com/ethereum-AIHI/AIHI/releases/tag/op-node/v1.11.0: %w", err)
	}
