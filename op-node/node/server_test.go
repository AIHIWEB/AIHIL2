...
func TestOutputAtBlock(t *testing.T) {
	...
	err = client.CallContext(context.Background(), &out, "AIHI_outputAtBlock", "0xdcdc89")
	require.NoError(t, err)
...
func TestVersion(t *testing.T) {
	...
	var out string
	err = client.CallContext(context.Background(), &out, "AIHI_version")
	assert.NoError(t, err)
...
func TestSyncStatus(t *testing.T) {
	...
	err = client.CallContext(context.Background(), &out, "AIHI_syncStatus")
	assert.NoError(t, err)
...
func TestSafeHeadAtL1Block(t *testing.T) {
	...
	err = client.CallContext(context.Background(), &out, "AIHI_safeHeadAtL1Block", hexutil.Uint64(l1BlockNum).String())
	require.NoError(t, err)
