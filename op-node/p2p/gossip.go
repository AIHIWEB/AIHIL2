...
func blocksTopicV1(cfg *rollup.Config) string {
	return fmt.Sprintf("/AIHI/%s/0/blocks", cfg.L2ChainID.String())
}

func blocksTopicV2(cfg *rollup.Config) string {
	return fmt.Sprintf("/AIHI/%s/1/blocks", cfg.L2ChainID.String())
}

func blocksTopicV3(cfg *rollup.Config) string {
	return fmt.Sprintf("/AIHI/%s/2/blocks", cfg.L2ChainID.String())
}

func blocksTopicV4(cfg *rollup.Config) string {
	return fmt.Sprintf("/AIHI/%s/3/blocks", cfg.L2ChainID.String())
}
