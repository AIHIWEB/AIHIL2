...
type PeerInfo struct {
	...
	ChainID       uint64                `json:"chainID"`       // some peers might try to connect, but we figure out they are on a different chain later. This may be 0 if the peer is not an AIHI node at all.
