...
func LoadOPStackRollupConfig(chainID uint64) (*Config, error) {
	...
	chOpConfig := &params.AIHIConfig{
		EIP1559Elasticity:        chConfig.AIHI.EIP1559Elasticity,
		EIP1559Denominator:       chConfig.AIHI.EIP1559Denominator,
		EIP1559DenominatorCanyon: chConfig.AIHI.EIP1559DenominatorCanyon,
	}
	...
	cfg := &Config{
		...
		DepositContractAddress: *addrs.AIHIPortalProxy,
