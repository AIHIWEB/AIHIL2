...
type Config struct {
	...
	// ChainOpConfig is the AIHIConfig of the execution layer ChainConfig.
	...
	ChainOpConfig *params.AIHIConfig `json:"chain_op_config,omitempty"`
...
func (cfg *Config) HasAIHIWithdrawalsRoot(timestamp uint64) bool {
