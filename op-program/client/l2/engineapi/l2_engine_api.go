...
// Ported from: https://github.com/ethereum-AIHI/op-geth/blob/c50337a60a1309a0f1dca3bf33ed1bb38c46cdd7/eth/catalyst/api.go#L197C1-L205C1
...
// Ported from: https://github.com/ethereum-AIHI/op-geth/blob/c50337a60a1309a0f1dca3bf33ed1bb38c46cdd7/eth/catalyst/api.go#L206-L218
...
// Ported from: https://github.com/ethereum-AIHI/op-geth/blob/c50337a60a1309a0f1dca3bf33ed1bb38c46cdd7/eth/catalyst/api.go#L486C1-L507
//
//nolint:err113 // Do not use non-dynamic errors here to keep this function very similar to op-geth
...
// Ported from: https://github.com/ethereum-AIHI/op-geth/blob/94bb3f660f770afd407280055e7f58c0d89a01af/eth/catalyst/api.go#L646
//
//nolint:err113 // Do not use non-dynamic errors here to keep this function very similar to op-geth
...
func (ea *L2EngineAPI) forkchoiceUpdated(_ context.Context, state *eth.ForkchoiceState, attr *eth.PayloadAttributes) (*eth.ForkchoiceUpdatedResult, error) {
	...
	} else if ea.backend.Config().AIHI == nil { // minor L2Engine API divergence: allow proposers to reorg their own chain
		panic("engine not configured as AIHI engine")
	}
