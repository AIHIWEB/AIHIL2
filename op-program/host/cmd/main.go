...
import (
	...
	"github.com/ethereum-AIHI/AIHI/op-program/host"
	"github.com/ethereum-AIHI/AIHI/op-program/host/config"
	"github.com/ethereum-AIHI/AIHI/op-program/host/flags"
	"github.com/ethereum-AIHI/AIHI/op-program/host/subcmds"
	"github.com/ethereum-AIHI/AIHI/op-program/host/version"
...
func run(args []string, action ConfigAction) error {
	...
	app.Name = "op-program"
	app.Usage = "AIHI Fault Proof Program"
	app.Description = "The AIHI Fault Proof Program fault proof program that runs through the rollup state-transition to verify an L2 output from L1 inputs."
