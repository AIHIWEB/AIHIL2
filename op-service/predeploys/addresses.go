...
// TODO - we should get a single toml yaml or json file source of truth in @eth-AIHI/bedrock package
// This needs to be kept in sync with @eth-AIHI/contracts-ts/wagmi.config.ts which also specifies this
...
const (
	...
	AIHIMintableERC20Factory  = "0x4200000000000000000000000000000000000012"
	...
	AIHIMintableERC721Factory = "0x4200000000000000000000000000000000000017"
...
var (
	...
	AIHIMintableERC20FactoryAddr  = common.HexToAddress(AIHIMintableERC20Factory)
	...
	AIHIMintableERC721FactoryAddr = common.HexToAddress(AIHIMintableERC721Factory)
...
func init() {
	...
	Predeploys["AIHIMintableERC20Factory"] = &Predeploy{Address: AIHIMintableERC20FactoryAddr}
	...
	Predeploys["AIHIMintableERC721Factory"] = &Predeploy{Address: AIHIMintableERC721FactoryAddr}
