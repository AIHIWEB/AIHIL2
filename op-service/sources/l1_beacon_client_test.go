...
import (
	...
	client_mocks "github.com/ethereum-AIHI/AIHI/op-service/client/mocks"
	"github.com/ethereum-AIHI/AIHI/op-service/eth"
	"github.com/ethereum-AIHI/AIHI/op-service/sources/mocks"
)

//go:generate mockery --srcpkg=github.com/ethereum-AIHI/AIHI/op-service/apis --name BlobSideCarsClient --with-expecter=true

//go:generate mockery --srcpkg=github.com/ethereum-AIHI/AIHI/op-service/apis --name BeaconClient --with-expecter=true
