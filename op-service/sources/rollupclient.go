...
func (r *RollupClient) OutputAtBlock(ctx context.Context, blockNum uint64) (*eth.OutputResponse, error) {
	...
	err := r.rpc.CallContext(ctx, &output, "AIHI_outputAtBlock", hexutil.Uint64(blockNum))
	return output, err
}
