...
import (
	...
	"github.com/ethereum-AIHI/AIHI/op-validator/pkg/validations"

	oplog "github.com/ethereum-AIHI/AIHI/op-service/log"
	"github.com/ethereum-AIHI/AIHI/op-validator/pkg/service"
...
func main() {
	...
	app.Usage = "AIHI Validator Service"
	app.Description = "CLI to validate AIHI L2 deployments"
