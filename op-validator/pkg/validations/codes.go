...
var descriptions = map[string]string{
	...
	// AIHI Mintable ERC20 Factory validations
	"MERC20F-10": "AIHIMintableERC20Factory version mismatch",
	"MERC20F-20": "AIHIMintableERC20Factory implementation address mismatch",
	"MERC20F-30": "AIHIMintableERC20Factory BRIDGE address mismatch",
	"MERC20F-40": "AIHIMintableERC20Factory bridge address mismatch",
	...
	// AIHI Portal validations
	"PORTAL-10": "AIHIPortal version mismatch",
	"PORTAL-20": "AIHIPortal implementation address mismatch",
	"PORTAL-30": "AIHIPortal disputeGameFactory address mismatch",
	"PORTAL-40": "AIHIPortal systemConfig address mismatch",
	"PORTAL-50": "AIHIPortal superchainConfig address mismatch",
	"PORTAL-60": "AIHIPortal guardian address mismatch",
	"PORTAL-70": "AIHIPortal paused state mismatch with superchainConfig",
	"PORTAL-80": "AIHIPortal l2Sender not set to default value",
