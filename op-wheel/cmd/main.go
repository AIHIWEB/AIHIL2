...
import (
	...
	wheel "github.com/ethereum-AIHI/AIHI/op-wheel"
)
...
func main() {
	...
	app.Name = "op-wheel"
	app.Usage = "AIHI Wheel is a CLI tool for the execution engine"
	app.Description = "AIHI Wheel is a CLI tool to direct the engine one way or the other with DB cheats and Engine API routines."
