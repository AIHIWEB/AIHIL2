...
interface ISystemConfig {
    ...
    function AIHI_MINTABLE_ERC20_FACTORY_SLOT() external view returns (bytes32);
    function AIHI_PORTAL_SLOT() external view returns (bytes32);
    ...
    function AIHIMintableERC20Factory() external view returns (address addr_);
    function AIHIPortal() external view returns (address addr_);
