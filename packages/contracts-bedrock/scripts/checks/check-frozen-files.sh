...
ALLOWED_FILES=(
  ...
  # "src/L1/AIHIPortal2.sol:AIHIPortal2"
  ...
  "src/L2/AIHIMintableERC721.sol:AIHIMintableERC721"
  "src/L2/AIHIMintableERC721Factory.sol:AIHIMintableERC721Factory"
  "src/L2/AIHISuperchainERC20.sol:AIHISuperchainERC20"
  "src/L2/AIHISuperchainERC20Beacon.sol:AIHISuperchainERC20Beacon"
  "src/L2/AIHISuperchainERC20Factory.sol:AIHISuperchainERC20Factory"
  ...
  "src/universal/AIHIMintableERC20.sol:AIHIMintableERC20"
  "src/universal/AIHIMintableERC20Factory.sol:AIHIMintableERC20Factory"
