...
contract Deploy is Deployer {
    ...
    function _proxies() internal view returns (Types.ContractSet memory proxies_) {
        proxies_ = Types.ContractSet({
            ...
            AIHIMintableERC20Factory: artifacts.getAddress("AIHIMintableERC20FactoryProxy"),
            AIHIPortal: artifacts.getAddress("AIHIPortalProxy"),
    ...
    function deployImplementations(bool _isInterop) public {
        ...
        Types.ContractSet memory impls = Types.ContractSet({
            ...
            AIHIMintableERC20Factory: address(dio.AIHIMintableERC20FactoryImpl()),
            AIHIPortal: address(dio.AIHIPortalImpl()),
        ...
        ChainAssertions.checkAIHIPortal2({ _contracts: impls, _cfg: cfg, _isProxy: false });
        ChainAssertions.checkETHLockbox({ _contracts: impls, _cfg: cfg, _isProxy: false });
        ChainAssertions.checkAIHIMintableERC20Factory({ _contracts: impls, _isProxy: false });
    ...
    function deployOpChain() public {
        ...
        artifacts.save("AIHIMintableERC20FactoryProxy", address(deployOutput.AIHIMintableERC20FactoryProxy));
        ...
        artifacts.save("AIHIPortalProxy", address(deployOutput.AIHIPortalProxy));
        artifacts.save("AIHIPortal2Proxy", address(deployOutput.AIHIPortalProxy));
            ...
            _data: abi.encodeCall(
                ...
                (
                    ...
                    ISystemConfig.Addresses({
                        ...
                        AIHIPortal: artifacts.mustGetAddress("AIHIPortalProxy"),
                        AIHIMintableERC20Factory: artifacts.mustGetAddress("AIHIMintableERC20FactoryProxy")
                    }),
                    cfg.l2ChainID()
                )
            )
