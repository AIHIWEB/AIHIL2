...
contract DeployAuthSystem is Script {
    ...
    function getIOContracts() public view returns (DeployAuthSystemInput dasi_, DeployAuthSystemOutput daso_) {
        dasi_ = DeployAuthSystemInput(DeployUtils.toIOAddress(msg.sender, "AIHI.DeployAuthSystemInput"));
        daso_ = DeployAuthSystemOutput(DeployUtils.toIOAddress(msg.sender, "AIHI.DeployAuthSystemOutput"));
    }
}
