...
contract DeployImplementations2 is Script {
    ...
    function run(Input memory _input) public returns (Output memory output_) {
        ...
        deployAIHIMintableERC20FactoryImpl(output_);
        deployAIHIPortalImpl(_input, output_);
        ...
        returns (IOPContractsManager opcm_)
    {
        IOPContractsManager.Implementations memory implementations = IOPContractsManager.Implementations({
            ...
            AIHIPortalImpl: address(_output.AIHIPortalImpl),
            ethLockboxImpl: address(_output.ethLockboxImpl),
            systemConfigImpl: address(_output.systemConfigImpl),
            AIHIMintableERC20FactoryImpl: address(_output.AIHIMintableERC20FactoryImpl),
    ...
    function deployAIHIMintableERC20FactoryImpl(Output memory _output) private {
        ...
        _output.AIHIMintableERC20FactoryImpl = impl;
    }
    ...
    function deployAIHIPortalImpl(Input memory _input, Output memory _output) private {
    ...
    function assertValidOutput(Input memory _input, Output memory _output) private view {
        ...
        address[] memory addrs1 = Solarray.addresses(
            ...
            address(_output.AIHIPortalImpl),
        ...
        address[] memory addrs2 = Solarray.addresses(
            ...
            address(_output.AIHIMintableERC20FactoryImpl),
        ...
        assertValidAIHIMintableERC20FactoryImpl(_input, _output);
        assertValidAIHIPortalImpl(_input, _output);
    ...
    function assertValidAIHIPortalImpl(Input memory, Output memory _output) private view {
        IAIHIPortal portal = _output.AIHIPortalImpl;
    ...
    function assertValidETHLockboxImpl(Input memory, Output memory _output) private view {
        ...
        require(lockbox.authorizedPortals(_output.AIHIPortalImpl) == false, "ELB-20");
    }
    ...
    function assertValidAIHIMintableERC20FactoryImpl(Input memory, Output memory _output) private view {
        IAIHIMintableERC20Factory factory = _output.AIHIMintableERC20FactoryImpl;
