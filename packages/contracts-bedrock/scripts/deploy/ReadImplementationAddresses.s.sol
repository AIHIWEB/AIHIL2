...
contract ReadImplementationAddressesOutput is BaseDeployIO {
    ...
    address internal _AIHIMintableERC20Factory;
    ...
    function set(bytes4 _sel, address _addr) public {
        ...
        else if (_sel == this.AIHIPortal.selector) _AIHIPortal = _addr;
        ...
        else if (_sel == this.AIHIMintableERC20Factory.selector) _AIHIMintableERC20Factory = _addr;
    ...
    function AIHIPortal() public view returns (address) {
        require(_AIHIPortal != address(0), "ReadImplementationAddressesOutput: AIHIPortal not set");
        return _AIHIPortal;
    }
    ...
    function AIHIMintableERC20Factory() public view returns (address) {
        require(
            _AIHIMintableERC20Factory != address(0),
            "ReadImplementationAddressesOutput: AIHIMintableERC20Factory not set"
        );
        return _AIHIMintableERC20Factory;
    }
