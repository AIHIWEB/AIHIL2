...
AIHI_PORTAL_IMPL=$(echo "$IMPLEMENTATIONS" | sed -n '2p')
SYSTEM_CONFIG_IMPL=$(echo "$IMPLEMENTATIONS" | sed -n '3p')
AIHI_MINTABLE_ERC20_FACTORY_IMPL=$(echo "$IMPLEMENTATIONS" | sed -n '4p')
...
IMPL_ADDRESSES=(
    ...
    "$AIHI_PORTAL_IMPL"
    "$SYSTEM_CONFIG_IMPL"
    "$AIHI_MINTABLE_ERC20_FACTORY_IMPL"
