...
contract StandardValidatorBase {
    ...
    address public AIHIPortalImpl;
    address public systemConfigImpl;
    address public AIHIMintableERC20FactoryImpl;
    ...
    constructor(
        ...
        AIHIPortalImpl = _implementations.AIHIPortalImpl;
        systemConfigImpl = _implementations.systemConfigImpl;
        AIHIMintableERC20FactoryImpl = _implementations.AIHIMintableERC20FactoryImpl;
        ...
        returns (string memory)
    {
        ...
        _errors = assertValidAIHIMintableERC20Factory(_errors, _sysCfg, _admin);
        _errors = assertValidL1ERC721Bridge(_errors, _sysCfg, _admin);
        _errors = assertValidAIHIPortal(_errors, _sysCfg, _admin);
    ...
    function AIHIPortalVersion() public pure virtual returns (string memory) {
        return "3.10.0";
    }
    ...
    function AIHIMintableERC20FactoryVersion() public pure virtual returns (string memory) {
        return "1.9.0";
    }
        ...
        returns (string memory)
    {
        ...
        IAIHIPortal2 _portal = IAIHIPortal2(payable(_sysCfg.AIHIPortal()));
    ...
    function assertValidAIHIMintableERC20Factory(
        string memory _errors,
        ISystemConfig _sysCfg,
        IProxyAdmin _admin
    )
        ...
        returns (string memory)
    {
        IAIHIMintableERC20Factory _factory = IAIHIMintableERC20Factory(_sysCfg.AIHIMintableERC20Factory());
        _errors =
            internalRequire(stringEq(_factory.version(), AIHIMintableERC20FactoryVersion()), "MERC20F-10", _errors);
        _errors = internalRequire(
            _admin.getProxyImplementation(address(_factory)) == AIHIMintableERC20FactoryImpl, "MERC20F-20", _errors
        );
    ...
    function assertValidAIHIPortal(
        string memory _errors,
        ISystemConfig _sysCfg,
        IProxyAdmin _admin
    )
    ...
    {
        IAIHIPortal2 _portal = IAIHIPortal2(payable(_sysCfg.AIHIPortal()));
        _errors = internalRequire(stringEq(_portal.version(), AIHIPortalVersion()), "PORTAL-10", _errors);
        _errors =
            internalRequire(_admin.getProxyImplementation(address(_portal)) == AIHIPortalImpl, "PORTAL-20", _errors);
...
contract StandardValidatorV200 is StandardValidatorBase {
    ...
    function AIHIPortalVersion() public pure override returns (string memory) {
        return "3.13.0";
    }
    ...
    function AIHIMintableERC20FactoryVersion() public pure override returns (string memory) {
        return "1.10.1";
    }
