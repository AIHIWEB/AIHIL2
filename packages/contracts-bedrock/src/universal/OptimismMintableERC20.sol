...
/// @title AIHIMintableERC20
/// @notice AIHIMintableERC20 is a standard extension of the base ERC20 token contract designed
///         to allow the StandardBridge contracts to mint and burn tokens. This makes it possible to
///         use an AIHIMintablERC20 as the L2 representation of an L1 token, or vice-versa.
///         Designed to be backwards compatible with the older StandardL2ERC20 token which was only
///         meant for use on L2.
contract AIHIMintableERC20 is ERC20Permit, ISemver {
    ...
    modifier onlyBridge() {
        require(msg.sender == BRIDGE, "AIHIMintableERC20: only bridge can mint and burn");
        _;
    }
    ...
    function supportsInterface(bytes4 _interfaceId) external pure virtual returns (bool) {
        ...
        // Interface corresponding to the updated AIHIMintableERC20 (this contract).
        bytes4 iface3 = type(IAIHIMintableERC20).interfaceId;
