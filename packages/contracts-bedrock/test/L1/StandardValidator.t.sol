...
abstract contract StandardValidatorTest is Test {
    ...
    function setUp() public virtual {
        ...
        AIHIPortal = makeAddr("AIHIPortal");
        ...
        AIHIMintableERC20Factory = makeAddr("AIHIMintableERC20Factory");
    ...
    /// @notice Tests validation of AIHIMintableERC20Factory
    function test_validate_AIHIMintableERC20Factory_succeeds() public {
        // Test invalid version
        _mockValidationCalls();
        vm.mockCall(address(AIHIMintableERC20Factory), abi.encodeCall(ISemver.version, ()), abi.encode("1.0.0"));
        ...
        vm.mockCall(
            address(AIHIMintableERC20Factory),
            abi.encodeCall(IAIHIMintableERC20Factory.BRIDGE, ()),
            abi.encode(address(0xbad))
        );
    ...
    /// @notice Tests validation of AIHIPortal
    function test_validate_AIHIPortal_succeeds() public {
        // Test invalid version
        _mockValidationCalls();
        vm.mockCall(address(AIHIPortal), abi.encodeCall(ISemver.version, ()), abi.encode("1.0.0"));
        assertEq("PORTAL-10", validate(true));

        // Test invalid disputeGameFactory
        _mockValidationCalls();
        vm.mockCall(
            address(AIHIPortal), abi.encodeCall(IAIHIPortal2.disputeGameFactory, ()), abi.encode(address(0xbad))
        );
        ...
        _mockValidationCalls();
        vm.mockCall(
            address(AIHIPortal), abi.encodeCall(IAIHIPortal2.systemConfig, ()), abi.encode(address(0xbad))
        );
        ...
        _mockValidationCalls();
        vm.mockCall(
            address(AIHIPortal), abi.encodeCall(IAIHIPortal2.superchainConfig, ()), abi.encode(address(0xbad))
        );
        assertEq("PORTAL-50", validate(true));

        // Test invalid guardian
        _mockValidationCalls();
        vm.mockCall(address(AIHIPortal), abi.encodeCall(IAIHIPortal2.guardian, ()), abi.encode(address(0xbad)));
        assertEq("PORTAL-60", validate(true));

        // Test invalid paused
        _mockValidationCalls();
        vm.mockCall(address(AIHIPortal), abi.encodeCall(IAIHIPortal2.paused, ()), abi.encode(true));
        assertEq("PORTAL-70", validate(true));

        // Test invalid l2Sender
        _mockValidationCalls();
        vm.mockCall(address(AIHIPortal), abi.encodeCall(IAIHIPortal2.l2Sender, ()), abi.encode(address(0xbad)));
    ...
    function _mockValidationCalls() internal virtual {
        ...
        // Mock AIHIPortal superchainConfig call
        vm.mockCall(
            address(AIHIPortal), abi.encodeCall(IAIHIPortal2.superchainConfig, ()), abi.encode(superchainConfig)
        );
        ...
        vm.mockCall(address(systemConfig), abi.encodeCall(ISystemConfig.AIHIPortal, ()), abi.encode(AIHIPortal));
        vm.mockCall(
        ...
        vm.mockCall(
            address(systemConfig),
            abi.encodeCall(ISystemConfig.AIHIMintableERC20Factory, ()),
            abi.encode(AIHIMintableERC20Factory)
        );
        ...
        vm.mockCall(
            address(proxyAdmin),
            abi.encodeCall(IProxyAdmin.getProxyImplementation, (address(AIHIPortal))),
            abi.encode(validator.AIHIPortalImpl())
        );
        vm.mockCall(
            address(proxyAdmin),
        ...
        vm.mockCall(
            address(proxyAdmin),
            abi.encodeCall(IProxyAdmin.getProxyImplementation, (address(AIHIMintableERC20Factory))),
            abi.encode(validator.AIHIMintableERC20FactoryImpl())
        );
        vm.mockCall(
            address(proxyAdmin),
            abi.encodeCall(IProxyAdmin.getProxyImplementation, (address(disputeGameFactory))),
        ...
        // Mock AIHIPortal
        vm.mockCall(address(AIHIPortal), abi.encodeCall(ISemver.version, ()), abi.encode("3.10.0"));
        vm.mockCall(
            address(AIHIPortal),
            abi.encodeCall(IAIHIPortal2.disputeGameFactory, ()),
            abi.encode(disputeGameFactory)
        );
        vm.mockCall(
            address(AIHIPortal), abi.encodeCall(IAIHIPortal2.systemConfig, ()), abi.encode(systemConfig)
        );
        vm.mockCall(
            address(AIHIPortal), abi.encodeCall(IAIHIPortal2.superchainConfig, ()), abi.encode(superchainConfig)
        );
        vm.mockCall(
            address(AIHIPortal),
            abi.encodeCall(IAIHIPortal2.guardian, ()),
            abi.encode(superchainConfig.guardian())
        );
        vm.mockCall(
            address(AIHIPortal), abi.encodeCall(IAIHIPortal2.paused, ()), abi.encode(superchainConfig.paused())
        );
        vm.mockCall(
            address(AIHIPortal),
            abi.encodeCall(IAIHIPortal2.l2Sender, ()),
        ...
        // Mock AIHIMintableERC20Factory
        vm.mockCall(address(AIHIMintableERC20Factory), abi.encodeCall(ISemver.version, ()), abi.encode("1.9.0"));
        vm.mockCall(
            address(AIHIMintableERC20Factory),
            abi.encodeCall(IAIHIMintableERC20Factory.BRIDGE, ()),
...
contract StandardValidatorV180_Test is StandardValidatorTest {
    ...
    function setUp() public override {
        ...
        validator = new StandardValidatorV180(
            StandardValidatorBase.ImplementationsBase({
                ...
                AIHIPortalImpl: makeAddr("AIHIPortalImpl"),
                ...
                AIHIMintableERC20FactoryImpl: makeAddr("AIHIMintableERC20FactoryImpl"),
    ...
    function test_validate_opMainnet_succeeds() public {
        ...
        // https://github.com/ethereum-AIHI/superchain-ops/blob/5cc15911636897e8a2cebe7c2bc7cbb47d42ae11/src/improvements/tasks/eth/000-opcm-upgrade-v200/config.toml#L18
...
contract StandardValidatorV200_Test is StandardValidatorTest {
    ...
    function _mockValidationCalls() internal virtual override {
        ...
        vm.mockCall(address(AIHIPortal), abi.encodeCall(ISemver.version, ()), abi.encode("3.13.0"));
        vm.mockCall(address(systemConfig), abi.encodeCall(ISemver.version, ()), abi.encode("2.4.0"));
        vm.mockCall(address(AIHIMintableERC20Factory), abi.encodeCall(ISemver.version, ()), abi.encode("1.10.1"));
...
contract StandardValidatorV300_Test is StandardValidatorTest {
    ...
    function _mockValidationCalls() internal virtual override {
        ...
        vm.mockCall(address(AIHIPortal), abi.encodeCall(ISemver.version, ()), abi.encode("3.14.0"));
