...
contract SystemConfig_Initialize_Test is SystemConfig_Init {
    ...
    function test_constructor_succeeds() external view {
        ...
        assertEq(address(impl.AIHIPortal()), address(0));
        assertEq(address(impl.AIHIMintableERC20Factory()), address(0));
    }
    ...
    function test_initialize_succeeds() external view {
        ...
        assertEq(address(systemConfig.AIHIPortal()), address(AIHIPortal2));
        assertEq(addrs.AIHIPortal, address(AIHIPortal2));
        assertEq(address(systemConfig.AIHIMintableERC20Factory()), address(AIHIMintableERC20Factory));
        assertEq(addrs.AIHIMintableERC20Factory, address(AIHIMintableERC20Factory));
