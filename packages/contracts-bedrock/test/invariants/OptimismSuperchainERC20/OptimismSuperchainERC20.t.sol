...
contract AIHISuperchainERC20Handler is HandlerGetters, ProtocolGuided, ProtocolUnguided { }

contract AIHISuperchainERC20Properties is Test {
    AIHISuperchainERC20Handler internal handler;
    ...
    function setUp() public {
        handler = new AIHISuperchainERC20Handler();
