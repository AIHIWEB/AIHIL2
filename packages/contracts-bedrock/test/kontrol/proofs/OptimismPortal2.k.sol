...
import { IAIHIPortal2 as AIHIPortal } from "interfaces/L1/IAIHIPortal2.sol";
import { ISuperchainConfig as SuperchainConfig } from "interfaces/L1/ISuperchainConfig.sol";

contract AIHIPortal2Kontrol is DeploymentSummaryFaultProofs, KontrolUtils {
    ...
    function setUpInlined() public {
        AIHIPortal = AIHIPortal(payable(AIHIPortalProxyAddress));
    ...
    function prove_finalizeWithdrawalTransaction_paused(Types.WithdrawalTransaction calldata _tx) external {
        ...
        // Pause AIHI Portal
        vm.prank(AIHIPortal.guardian());
        superchainConfig.pause("identifier");

        vm.expectRevert(AIHIPortal.AIHIPortal_CallPaused.selector);
        AIHIPortal.finalizeWithdrawalTransaction(_tx);
    }
        ...
        internal
    {
        ...
        vm.expectRevert(AIHIPortal.AIHIPortal_CallPaused.selector);
        AIHIPortal.proveWithdrawalTransaction(_tx, _l2OutputIndex, _outputRootProof, _withdrawalProof);
    }
