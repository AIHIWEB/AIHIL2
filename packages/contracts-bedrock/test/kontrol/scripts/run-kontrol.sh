...
module=AIHIPortal2Kontrol:$base_module
rekompile=--rekompile
# rekompile=
regen=--regen
# regen=
...
if [ "$SCRIPT_TESTS" == true ]; then
  test_list=(
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused0" \
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused1(" \
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused2" \
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused3" \
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused4" \
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused5" \
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused6" \
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused7" \
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused8" \
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused9" \
    "AIHIPortal2Kontrol.prove_proveWithdrawalTransaction_paused10" \
    "AIHIPortal2Kontrol.prove_finalizeWithdrawalTransaction_paused" \
