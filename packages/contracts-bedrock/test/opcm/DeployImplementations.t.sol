...
contract DeployImplementationsOutput_Test is Test {
    ...
    function test_set_succeeds() public {
        ...
        IAIHIPortal AIHIPortalImpl = IAIHIPortal(payable(makeAddr("AIHIPortalImpl")));
        ...
        IAIHIMintableERC20Factory AIHIMintableERC20FactoryImpl =
            IAIHIMintableERC20Factory(makeAddr("AIHIMintableERC20FactoryImpl"));
        ...
        vm.etch(address(AIHIPortalImpl), hex"01");
        ...
        vm.etch(address(AIHIMintableERC20FactoryImpl), hex"01");
        ...
        dio.set(dio.AIHIPortalImpl.selector, address(AIHIPortalImpl));
        ...
        dio.set(dio.AIHIMintableERC20FactoryImpl.selector, address(AIHIMintableERC20FactoryImpl));
        ...
        assertEq(address(AIHIPortalImpl), address(dio.AIHIPortalImpl()), "100");
        ...
        assertEq(address(AIHIMintableERC20FactoryImpl), address(dio.AIHIMintableERC20FactoryImpl()), "900");
    ...
    function test_getters_whenNotSet_reverts() public {
        ...
        vm.expectRevert(expectedErr);
        dio.AIHIMintableERC20FactoryImpl();
    ...
    function test_getters_whenAddrHasNoCode_reverts() public {
        ...
        dio.set(dio.AIHIPortalImpl.selector, emptyAddr);
        vm.expectRevert(expectedErr);
        dio.AIHIPortalImpl();
        ...
        dio.set(dio.AIHIMintableERC20FactoryImpl.selector, emptyAddr);
        vm.expectRevert(expectedErr);
        dio.AIHIMintableERC20FactoryImpl();
    }
}
...
contract DeployImplementations_Test is Test {
    ...
    function test_reuseImplementation_succeeds() public {
        ...
        deployImplementations.deployAIHIMintableERC20FactoryImpl(dio);
        deployImplementations.deployAIHIPortalImpl(dii, dio);
        ...
        address AIHIMintableERC20FactoryImpl = address(dio.AIHIMintableERC20FactoryImpl());
        address AIHIPortalImpl = address(dio.AIHIPortalImpl());
        ...
        assertEq(AIHIMintableERC20FactoryImpl, address(dio.AIHIMintableERC20FactoryImpl()), "500");
        assertEq(AIHIPortalImpl, address(dio.AIHIPortalImpl()), "600");
