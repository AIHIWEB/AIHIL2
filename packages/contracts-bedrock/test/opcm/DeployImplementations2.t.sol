...
contract DeployImplementations2_Test is Test {
    ...
    function test_reuseImplementation_succeeds() public {
        ...
        assertEq(
            address(output1.AIHIMintableERC20FactoryImpl), address(output2.AIHIMintableERC20FactoryImpl), "500"
        );
        assertEq(address(output1.AIHIPortalImpl), address(output2.AIHIPortalImpl), "600");
