...
contract DeployOPChainOutput_Test is Test {
    ...
    function test_set_succeeds() public {
        ...
        (IProxy AIHIMintableERC20FactoryProxy) =
            DeployUtils.buildERC1967ProxyWithImpl("AIHIMintableERC20FactoryProxy");
        ...
        (IProxy AIHIPortalProxy) = DeployUtils.buildERC1967ProxyWithImpl("AIHIPortalProxy");
        ...
        doo.set(doo.AIHIMintableERC20FactoryProxy.selector, address(AIHIMintableERC20FactoryProxy));
        ...
        doo.set(doo.AIHIPortalProxy.selector, address(AIHIPortalProxy));
        ...
        assertEq(address(AIHIMintableERC20FactoryProxy), address(doo.AIHIMintableERC20FactoryProxy()), "500");
        ...
        assertEq(address(AIHIPortalProxy), address(doo.AIHIPortalProxy()), "800");
    ...
    function test_getters_whenNotSet_reverts() public {
        ...
        vm.expectRevert(expectedErr);
        doo.AIHIMintableERC20FactoryProxy();
    ...
    function test_getters_whenAddrHasNoCode_reverts() public {
        ...
        doo.set(doo.AIHIMintableERC20FactoryProxy.selector, emptyAddr);
        vm.expectRevert(expectedErr);
        doo.AIHIMintableERC20FactoryProxy();
        ...
        doo.set(doo.AIHIPortalProxy.selector, emptyAddr);
        vm.expectRevert(expectedErr);
        doo.AIHIPortalProxy();
