...
contract InteropMigration_Test is Test {
    ...
    function test_migrate_succeeds() public {
        ...
        address portal = makeAddr("AIHIPortal");
        ...
        vm.mockCall(
            ...
            abi.encodeCall(ISystemConfig.AIHIPortal, ()),
            abi.encode(portal)
        );
        vm.etch(dgf, hex"01");
        vm.mockCall(portal, abi.encodeCall(IAIHIPortal.disputeGameFactory, ()), abi.encode(dgf));
