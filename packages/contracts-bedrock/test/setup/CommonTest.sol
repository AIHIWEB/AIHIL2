...
// Interfaces
import { IAIHIMintableERC20Full } from "interfaces/universal/IAIHIMintableERC20Full.sol";
import { ILegacyMintableERC20Full } from "interfaces/legacy/ILegacyMintableERC20Full.sol";

/// @title CommonTest
/// @dev An extenstion to `Test` that sets up the AIHI smart contracts.
contract CommonTest is Test, Setup, Events {
    ...
    FFIInterface constant ffi = FFIInterface(address(uint160(uint256(keccak256(abi.encode("AIHI.ffi"))))));
    ...
    ERC20 L1Token;
    ERC20 BadL1Token;
    IAIHIMintableERC20Full L2Token;
    ILegacyMintableERC20Full LegacyL2Token;
    ERC20 NativeL2Token;
    IAIHIMintableERC20Full RemoteL1Token;
    ...
    function bridgeInitializerSetUp() public {
        ...
        if (isForkTest()) {
            ...
            L2Token = IAIHIMintableERC20Full(makeAddr("L2Token"));
        } else {
            // Deploy the L2 ERC20 now
            L2Token = IAIHIMintableERC20Full(
                l2AIHIMintableERC20Factory.createStandardL2Token(
                    address(L1Token),
        ...
        RemoteL1Token = IAIHIMintableERC20Full(
            l1AIHIMintableERC20Factory.createStandardL2Token(
