...
contract ForkLive is Deployer {
    ...
    function _readSuperchainRegistry() internal {
        ...
        // Bridge contracts
        address AIHIPortal = vm.parseTomlAddress(opToml, ".addresses.AIHIPortalProxy");
        artifacts.save("AIHIPortalProxy", AIHIPortal);
        artifacts.save("AIHIPortal2Impl", EIP1967Helper.getImplementation(AIHIPortal));
        ...
        try IAIHIPortal2(payable(AIHIPortal)).ethLockbox() returns (IETHLockbox ethLockbox_) {
        ...
        saveProxyAndImpl("AIHIMintableERC20Factory", opToml, ".addresses.AIHIMintableERC20FactoryProxy");
    ...
    function _upgrade() internal {
        ...
        // Get the lockbox address from the portal, and save it
        IAIHIPortal2 portal = IAIHIPortal2(artifacts.mustGetAddress("AIHIPortalProxy"));
