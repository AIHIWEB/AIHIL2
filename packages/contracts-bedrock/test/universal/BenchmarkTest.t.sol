...
// Free function for setting the prevBaseFee param in the AIHIPortal.
...
contract SetPrevBaseFee_Test is CommonTest {
    function test_setPrevBaseFee_succeeds() external {
        setPrevBaseFee(vm, address(AIHIPortal2), 100 gwei);
        (uint128 prevBaseFee,, uint64 prevBlockNum) = AIHIPortal2.params();
