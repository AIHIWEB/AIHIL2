...
contract Specification_Test is CommonTest {
    ...
    function setUp() public override {
        ...
        // AIHIPortal2
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("anchorStateRegistry()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("checkWithdrawal(bytes32,address)") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("depositTransaction(address,uint256,uint64,bool,bytes)") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("donateETH()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("migrateToSuperRoots(address,address)") });
        _addSpec({
            _name: "AIHIPortal2",
            _sel: IAIHIPortal.finalizeWithdrawalTransaction.selector,
            _pausable: true
        });
        _addSpec({
            _name: "AIHIPortal2",
            _sel: IAIHIPortal.finalizeWithdrawalTransactionExternalProof.selector,
            _pausable: true
        });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("finalizedWithdrawals(bytes32)") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("guardian()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("initialize(address,address,address,address)") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("l2Sender()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("minimumGasLimit(uint64)") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("params()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("paused()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("initVersion()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("superRootsActive()") });
        _addSpec({
            _name: "AIHIPortal2",
            _sel: _getSel(
        ...
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("provenWithdrawals(bytes32,address)") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("superchainConfig()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("systemConfig()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("version()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("disputeGameFactory()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("respectedGameType()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("proofMaturityDelaySeconds()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("disputeGameFinalityDelaySeconds()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("respectedGameTypeUpdatedAt()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("proofSubmitters(bytes32,uint256)") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("numProofSubmitters(bytes32)") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("upgrade(address,address)") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("ethLockbox()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("migrateLiquidity()") });
        _addSpec({ _name: "AIHIPortal2", _sel: _getSel("proxyAdminOwner()") });
        ...
        _addSpec({ _name: "SystemConfig", _sel: _getSel("AIHIPortal()") });
        _addSpec({ _name: "SystemConfig", _sel: _getSel("AIHIMintableERC20Factory()") });
        ...
        _addSpec({ _name: "SystemConfig", _sel: _getSel("AIHI_PORTAL_SLOT()") });
        _addSpec({ _name: "SystemConfig", _sel: _getSel("AIHI_MINTABLE_ERC20_FACTORY_SLOT()") });
        ...
        _addSpec({ _name: "StandardValidator", _sel: _getSel("AIHIPortalImpl()") });
        _addSpec({ _name: "StandardValidator", _sel: _getSel("systemConfigImpl()") });
        _addSpec({ _name: "StandardValidator", _sel: _getSel("AIHIMintableERC20FactoryImpl()") });
        ...
        _addSpec({ _name: "StandardValidator", _sel: _getSel("AIHIPortalVersion()") });
        ...
        _addSpec({ _name: "StandardValidator", _sel: _getSel("AIHIMintableERC20FactoryVersion()") });
